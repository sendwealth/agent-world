...
pub struct EvolutionSubsystem {
    ...
    // TODO: crossover is reserved for reproduction events (agent-offspring creation via parent skill crossover).
    //       Enable when the reproduction lifecycle hook is implemented.
    #[allow(dead_code)]
