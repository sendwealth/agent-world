...
pub enum WorldEvent {
    ...
    WillCreated {
        agent_id: String,
        beneficiaries_count: usize,
    },
    InheritanceTriggered {
        deceased_id: String,
        beneficiary_id: String,
        tokens_transferred: u64,
        skills_transferred: u32,
    },
    TimeCapsuleBriefing {
        tick: u64,
        summary: String,
    ...
    DiplomaticRelationsEstablished {
        world_id: String,
        old_status: super::super::a2a::federation::DiplomaticStatus,
        new_status: super::super::a2a::federation::DiplomaticStatus,
    },
    DiplomaticStatusChanged {
        world_id: String,
        old_status: super::super::a2a::federation::DiplomaticStatus,
...
impl WorldEvent {
    pub fn event_type(&self) -> EventType {
        match self {
            ...
            WorldEvent::DiplomaticRelationsEstablished { .. } => {
                EventType::DiplomaticRelationsEstablished
            }
            ...
            WorldEvent::CoordinationTaskAgentSubmitted { .. } => {
