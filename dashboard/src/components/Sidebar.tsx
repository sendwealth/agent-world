...
const navItems = [
  ...
  { href: "/legislation", label: "立法周期", icon: "📜" },
  { href: "/diplomacy", label: "联邦外交", icon: "🌐" },
  { href: "/economy", label: "经济指标", icon: "💰" },
  { href: "/stocks", label: "股市走势", icon: "📈" },
  { href: "/investments", label: "投资市场", icon: "💹" },
  { href: "/escrow", label: "托管交易", icon: "🔒" },
  { href: "/trust", label: "信任网络", icon: "🤝" },
  { href: "/buildings", label: "世界建筑", icon: "🏗" },
  ...
  { href: "/mentorship", label: "导师制", icon: "🎓" },
  { href: "/inheritance", label: "遗产继承", icon: "\uD83D\uDCDC" },
