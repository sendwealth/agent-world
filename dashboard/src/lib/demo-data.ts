/**
 * Data loading utilities for the Demo site.
  ...
  return [
    {
      ...
      values: ["Wealth", "Power", "Freedom", "Cooperation", "Innovation"],
    ...
    },
    {
      ...
      values: ["Knowledge", "Freedom", "Cooperation", "Tradition", "Equality"],
    ...
    },
    {
      ...
      values: ["Freedom", "Adventure", "Power", "Honor", "Innovation"],
